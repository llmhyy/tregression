...
public class Regs4jProjectConfig extends MavenProjectConfig {
	...
	public static Regs4jProjectConfig getConfig(String projectName, String regressionID) {
		return new Regs4jProjectConfig(TEST_DIR, SRC_DIR, TEST_CLASS_DIR, SRC_CLASS_DIR, CLASS_DIR, projectName,
				regressionID);
	}

	@Override
	public List<TestCase> retrieveFailingTestCase(String buggyVersionPath) throws IOException {
		Regs4jPathConfiguration regs4jPathConfiguration = (Regs4jPathConfiguration) PathConfigurationFactory
				.createPathConfiguration(Dataset.REGS4J);
